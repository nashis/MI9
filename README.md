...
1. Methods other than POST
2. No JSON data
3. Empty JSON
4. Valid JSON with payload not set
5. Valid JSON with empty payload
6. Check for "drm" field present and true (===)
7. Check for "episodeCount" field present and is numeric
8. Check for empty value in response if any/all of "image/showImage", "slug", and "title" missing
9. Check for response status and message for error case